...
const AGENTS = [
  ...
  {
    id: "chiefAgent",
    name: "Chief Agent v4 (CEO)",
    icon: "Eye",
    description: "CEO autonomo — pipeline de vendas, prospreccao, email, blog, OKRs, lead scoring, coaching. Reporta 2x/dia + planejamento semanal dom 20h.",
    category: "ia",
    dependsOn: null,
    schedule: "08:00 + 20:00 BRT, diario + dom 20h planejamento",
    metrica: "briefings_gerados",
  },
  {
    id: "securityAgent",
    name: "Security Agent",
  ...
  {
    id: "coachAgent",
    name: "Coach (integrado ao Chief)",
    icon: "GraduationCap",
    description: "Coaching absorvido pelo ChiefAgent v4 — briefings de 8h incluem secao de coaching.",
    category: "ia",
    dependsOn: "meta",
    schedule: "Integrado no Chief 8h/20h",
    metrica: null,
  },
];
